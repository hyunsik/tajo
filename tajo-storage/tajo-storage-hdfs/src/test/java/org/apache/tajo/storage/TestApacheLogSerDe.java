...
import org.apache.tajo.storage.text.ApacheLogLineSerDe;
...
public class TestApacheLogSerDe {
...
//    user_agent TEXT,
    ...
    schema.addColumn("col4", TajoDataTypes.Type.TEXT);
    ...
    schema.addColumn("col10", TajoDataTypes.Type.TEXT);
  }
  ...
  public void testVarioutType() throws IOException {
    ...
    TableMeta meta = CatalogUtil.newTableMeta(CatalogProtos.StoreType.TEXTFILE);
    meta.getOptions().set(StorageConstants.TEXT_SERDE_CLASS, ApacheLogLineSerDe.class.getName());
    meta.getOptions().set(StorageConstants.TEXT_DELIMITER, " ");

    Path tablePath = new Path(getResourcePath("dataset", "TestApacheLogSerDe"), "apache_access.log");
