...
public class TestColumn {
	...
	static final DataType Type1 = CatalogUtil.newDataType(Type.BLOB);
	static final DataType Type2 = CatalogUtil.newDataType(Type.INT4);
	static final DataType Type3 = CatalogUtil.newDataType(Type.INT8);
