...
public class DDLExecutor {
  ...
  public boolean execute(QueryContext queryContext, Session session, LogicalPlan plan) throws IOException {
  ...
  public static void alterTablespace(final TajoMaster.MasterContext context, final QueryContext queryContext,
    ...
    CatalogProtos.AlterTablespaceProto.Builder builder = CatalogProtos.AlterTablespaceProto.newBuilder();
    builder.setSpaceName(spaceName);
    if (alterTablespace.getSetType() == AlterTablespaceSetType.LOCATION) {
      CatalogProtos.AlterTablespaceProto.AlterTablespaceCommand.Builder commandBuilder =
          CatalogProtos.AlterTablespaceProto.AlterTablespaceCommand.newBuilder();
      commandBuilder.setType(CatalogProtos.AlterTablespaceProto.AlterTablespaceType.LOCATION);
      commandBuilder.setLocation(CatalogProtos.AlterTablespaceProto.SetLocation.newBuilder().setUri(alterTablespace.getLocation()));
